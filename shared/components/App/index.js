						...
						<div>
							...
							<Switch>
								...
								<PrivateRoute
									...
									path="/me/settings"
									render={props => (
										<UserSetting {...props}><UserSettingProfile /></UserSetting>
									)}
								/>
								<PrivateRoute
									exact
								...
								<Route
									...
									path="/u/:uid"
									render={props => (
										<UserStory {...props} uid={props.match.params.uid} />
									)}
								/>
