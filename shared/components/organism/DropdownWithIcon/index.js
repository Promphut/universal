      ...
      <div className="row">
        <FlatButton
          ...
          style={{
            ...
            width: '330px',
            height: '60px',
            border: open || editState ? '1px solid #e2e2e2' : 'none',
          }}
        >
          <div>
            <Text className="nunito-font" style={{ ...labelStyle }}>
              {menuItem &&
            ...
            <FontIcon
              ...
              style={{ fontSize: '30px', color: '#8f8f8f', float: 'right', top: '8px' }}
            >
              keyboard_arrow_down
            </FontIcon>
          </div>
        ...
        >
          ...
          <EditMenu open={editState} anchorEl={editWhere} onRequestClose={this.closeEdit}>
            <BoxMenu>
              {editMenu || ''}
            </BoxMenu>
          </EditMenu>
