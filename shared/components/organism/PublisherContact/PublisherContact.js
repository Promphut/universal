...
class PublisherContact extends React.Component {
  ...
  newContactCat = () => {
    ...
    api.newContactCat(contactCat).then((_cat) => {
  ...
  getCatById = _id => findLast(this.state.contactCats, { _id }) || {};
  ...
  deleteCate = () => {
    ...
    api.deleteContactCat(conid).then((res) => {
    ...
    return (
      <Container onSubmit={this.updateContactCat}>
        ...
        <div style={{ clear: 'both', overflow: 'hidden' }}>
          <div
            className="sans-font"
            style={{ marginTop: '20px', float: 'right', overflow: 'hidden' }}
          >
