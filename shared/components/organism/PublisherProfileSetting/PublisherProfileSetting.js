...
class PublisherProfileSetting extends React.Component {
  ...
  updatePublisher = (e) => {
    ...
    api
      .updatePublisher(this.state.publisher)
      .then((pub) => {
        this.publisher = pub;
    ...
    return (
      <Container onSubmit={this.updatePublisher}>
        <Flex>
          ...
          <Edit>
            <TextField value={pub.name} name="name" onChange={this.publisherChanged} />
          </Edit>
        </Flex>
        <Flex>
          <Title>
          ...
          <Edit>
            <TextField value={pub.desc} name="desc" onChange={this.publisherChanged} />
          </Edit>
        </Flex>
        <Title style={{ marginTop: '50px' }}>
          <div className="sans-font">Example</div>
        </Title>
        <TextStatus className="sans-font" style={{ color: '#C4C4C4', margin: '15px 0 5px 0' }}>
        ...
        <div style={{ border: '1px solid #c4c4c4', width: '350px' }}>
          <div style={{ background: '#f4f4f4', width: '100%', height: '140px' }} />
          <div style={{ background: 'white', width: '100%' }}>
            <div
              style={{ color: '#222', fontSize: '18px', margin: '5px 15px' }}
              className="sans-font"
            >
              {pub.name || 'Title'}
            </div>
            <div
              style={{ color: '#545454', fontSize: '14px', margin: '5px 15px' }}
              className="sans-font"
            >
              {pub.desc || 'This is a description'}
            </div>
            <TextStatus
              className="sans-font"
              style={{ color: '#C4C4C4', margin: '5px 15px', display: 'block', clear: 'both' }}
            >
              {config.FRONTURL}
            </TextStatus>
          </div>
          ...
          <Edit>
            <Social className="sans-font">
              ...
              <TextField
                ...
                name="channels.fb"
                value={pub.channels && pub.channels.fb}
                onChange={this.publisherChanged}
              />
            </Social>
            <Social className="sans-font">
              ...
              <TextField
                style={{ float: 'left', margin: '5px 0 0 0' }}
                name="channels.twt"
                value={pub.channels && pub.channels.twt}
                onChange={this.publisherChanged}
              />
            </Social>
            <Social className="sans-font">
              ...
              <TextField
                style={{ float: 'left', margin: '5px 0 0 0' }}
                name="channels.ig"
                value={pub.channels && pub.channels.ig}
                onChange={this.publisherChanged}
              />
            </Social>
            <Social className="sans-font">
              ...
              <TextField
                style={{ float: 'left', margin: '5px 0 0 0' }}
                name="channels.yt"
                value={pub.channels && pub.channels.yt}
                onChange={this.publisherChanged}
              />
            </Social>
          </Edit>
