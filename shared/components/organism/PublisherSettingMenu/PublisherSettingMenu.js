      ...
      <Wrapper>
        <SelectableList style={{ padding: 0 }}>
          <ListItem
            style={{
              ...styles.listItem,
              backgroundColor: (selectedIndex == '/editor' && theme.accentColor) ||
                (this.props.pathname == '/editor/' && theme.accentColor) ||
            ...
            nestedItems={[
              ...
              <ListItem
                ...
                style={{
                  ...styles.listNestedItem,
                  color: selectedIndex == '/editor/stories' ? theme.accentColor : 'white',
                }}
                primaryText="Stories"
              />,
              <ListItem
                ...
                style={{
                  ...styles.listNestedItem,
                  color: selectedIndex == '/editor/columns' ? theme.accentColor : 'white',
                }}
                primaryText="Columns"
              />,
              <ListItem
                ...
                style={{
                  ...styles.listNestedItem,
                  color: selectedIndex == '/editor/writers' ? theme.accentColor : 'white',
                }}
                primaryText="Writers"
              />,
            ]}
          ...
          <ListItem
            style={{
              ...styles.listItem,
              backgroundColor: (selectedIndex == '/editor/manage/news' && theme.accentColor) ||
                (this.props.pathname == '/editor/manage/news' && theme.accentColor) ||
                (this.props.pathname == '/editor/manage/stories' && theme.accentColor),
            }}
            onClick={() => this.toggleNested('manage')}
            value={
              (this.props.pathname == '/editor/manage/news' && this.props.pathname) ||
                (this.props.pathname == '/editor/manage/news' && this.props.pathname) ||
                (this.props.pathname == '/editor/manage/stories' && this.props.pathname)
            }
            primaryTogglesNestedList
            className="nunito-font"
            primaryText="Manage"
            ...
            nestedItems={[
              <ListItem
                ...
                style={{
                  ...styles.listNestedItem,
                  color: selectedIndex == '/editor/manage/news' ? theme.accentColor : 'white',
                }}
                primaryText="News"
              />,
              <ListItem
                ...
                style={{
                  ...styles.listNestedItem,
                  color: selectedIndex == '/editor/manage/stories' ? theme.accentColor : 'white',
                }}
                primaryText="Stories"
              />,
            ]}
          ...
          <ListItem
            style={{
              ...styles.listItem,
              backgroundColor: (selectedIndex == '/editor/settings/' && theme.accentColor) ||
                (this.props.pathname == '/editor/settings/columns' && theme.accentColor) ||
                (this.props.pathname == '/editor/settings/contact' && theme.accentColor) ||
                (this.props.pathname == '/editor/settings/publishing' && theme.accentColor),
            }}
            onClick={() => this.toggleNested('setting')}
            value={
              (this.props.pathname == '/editor/settings/' && this.props.pathname) ||
                (this.props.pathname == '/editor/settings/columns' && this.props.pathname) ||
                (this.props.pathname == '/editor/settings/contact' && this.props.pathname) ||
                (this.props.pathname == '/editor/settings/publishing' && this.props.pathname)
            }
            primaryTogglesNestedList
            className="nunito-font"
            ...
            nestedItems={[
              <ListItem
                ...
                style={{
                  ...styles.listNestedItem,
                  color: selectedIndex == '/editor/settings/' ? theme.accentColor : 'white',
              ...
              <ListItem
                ...
                style={{
                  ...styles.listNestedItem,
                  color: selectedIndex == '/editor/settings/contact' ? theme.accentColor : 'white',
                  display: this.isAdmin ? 'block' : 'none',
                }}
              ...
              <ListItem
                ...
                style={{
                  ...styles.listNestedItem,
                  color: selectedIndex == '/editor/settings/columns' ? theme.accentColor : 'white',
                }}
                primaryText="Column"
              />,
            ]}
