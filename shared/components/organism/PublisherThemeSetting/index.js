...
class PublisherThemeSetting extends React.Component {
  ...
  render() {
    ...
    let shade = [];
    for (let i = 1; i < 7; i++) {
      shade.push(<ShadeColor key={i} className={`bg${i}`} />);
    }
    return (
      <Container onSubmit={this.updateData}>
        <Flex>
          ...
          <Edit>
            <UploadPicture
              ...
              ratio={1920 / 350}
              path={`/publishers/${config.PID}/cover`}
              type="cover"
              size="1920x350"
              width={500}
              height={100}
          ...
          <Edit>
            <div className="row">
              <UploadPicture
                crop={false}
                src={theme.llogo}
                path={`/publishers/${config.PID}/llogo`}
                size=".svg"
                type="llogo"
                allowTypes="|svg+xml|"
                width={200}
              ...
              <UploadPicture
                crop={false}
                src={theme.llogoGif}
                path={`/publishers/${config.PID}/llogo/gif`}
                size=".gif"
                type="llogoGif"
                allowTypes="|gif|"
                width={200}
        ...
        <Flex>
          ...
          <Edit>
            <UploadPicture
              crop={false}
              src={uploadFavicon}
              path={`/publishers/${config.PID}/favicon`}
              size=".ico"
              type="favicon"
              allowTypes="|x-icon|vnd.microsoft.icon|"
              width={60}
              height={60}
            />
          </Edit>
          ...
          <Edit>
            <div className="row">
              <UploadPicture
                crop={false}
                src={uploadSLogo}
                path={`/publishers/${config.PID}/slogo`}
                size=".svg"
                type="slogo"
                allowTypes="|svg+xml|"
                width={60}
              ...
              <UploadPicture
                src={theme.slogoGif}
                path={`/publishers/${config.PID}/slogo/gif`}
                size=".gif"
                type="slogoGif"
                allowTypes="|gif|"
                width={60}
        ...
        <Flex>
          ...
          <Edit>
            <UploadPicture
              crop={false}
              src={uploadLogo}
              path={`/publishers/${config.PID}/logo`}
              size=".svg"
              type="logo"
              allowTypes="|svg+xml|"
              width={300}
          ...
          <Edit>
            <div className="row">
              <BoxColor id="color2" onClick={this.handleTouchTap1}>
                ...
                <i className="fa fa-angle-down" style={{ margin: '4px' }} aria-hidden="true" />
                <Popover
                  open={open1}
                  anchorEl={anchorEl1}
                ...
                >
                  <ChromePicker color={primaryColor} onChangeComplete={this.selectColor1} />
                </Popover>
              </BoxColor>
              <Desc className="sans-font">
                Primary color should be a major color that looks good on both white and black background
              </Desc>
            </div>
          </Edit>
        </Flex>
            ...
            <div className="row">
              <BoxColor id="color2" onClick={this.handleTouchTap2}>
                ...
                <Popover
                  ...
                  onRequestClose={this.handleRequestClose}
                >
                  <ChromePicker color={secondaryColor} onChangeComplete={this.selectColor2} />
                </Popover>
              </BoxColor>
              <Desc className="sans-font">
                Secondary Color may use for related information and as a gradient color
              </Desc>
            </div>
          </Edit>
        </Flex>
            ...
            <div className="row">
              <BoxColor id="color2" onClick={this.handleTouchTap3}>
                ...
                <Popover
                  ...
                  onRequestClose={this.handleRequestClose}
                >
                  <ChromePicker color={accentColor} onChangeComplete={this.selectColor3} />
                </Popover>
              </BoxColor>
              <Desc className="sans-font">
                Accent Color should be used for action button and interactive elements, such as text fields, progress bar and links
              </Desc>
            </div>
          </Edit>
        </Flex>
        <Flex>
          ...
          <Edit style={{ maxWidth: '490px' }}>
            ...
            <div
              className="row sans-font"
              style={{ border: '1px solid #e2e2e2', padding: '10px', margin: '20px 0 0 0' }}
            >
              <Topbar
                style={{
                  backgroundColor: colorTheme == 'light' ? 'white' : primaryColor,
                  marginBottom: '20px',
                }}
              >
                <i
                  ...
                  style={{
                    margin: '9px',
                    color: colorTheme == 'light' ? '#222' : 'white',
                    float: 'left',
                  }}
                >
                  menu
              ...
              <div className="col-6 " style={{ padding: '0 5px 0 5px' }}>
                <Example style={{ ...styles.example2 }}>
                  <strong className="serif-font" style={{ fontSize: '17px' }}>
                    Preview of the major color selection
                  </strong>
                  <br />
                  <br />
              ...
              <div className="col-6" style={{ padding: '0 5px 0 5px' }}>
                <Example
                  style={{ ...styles.example2, padding: '15px', fontSize: '11px', height: 'auto' }}
                  className="sans-font"
                >
        ...
        <div className="sans-font" style={{ marginTop: '30px', overflow: 'hidden' }}>
          ...
          <SecondaryButton
            ...
            style={{ float: 'right', margin: '0 20px 0 0' }}
          />
          <TextStatus style={{ color: error ? '#D8000C' : theme.accentColor, float: 'right' }}>
            {textStatus}
          </TextStatus>
        </div>
