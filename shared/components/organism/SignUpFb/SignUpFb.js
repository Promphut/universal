  ...
  render() {
    ...
    return (
      <Box>
        ...
        <div style={{ width: '70px', margin: '40px auto 20px auto' }}>
          <Avatar src={user.pic.medium} size={70} />
        </div>
        ...
        <div style={styles.btnCon}>
          <a
            href={
              `${config.BACKURL
                }/auth/facebook?publisher=${
                config.PID
                }&nextpathname=${
                encodeURIComponent(this.props.nextPathname)}`
            }
          >
            <RaisedButton
              ...
              icon={
                <i
                  ...
                  style={{ color: 'white', margin: '10px 10px 0 0', fontSize: '24px' }}
                  aria-hidden="true"
                />
              }
              style={{ ...styles.button }}
