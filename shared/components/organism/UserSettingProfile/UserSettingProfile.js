    ...
    return (
      <Container onSubmit={this.updateData} ref="userProfile" className="marginTop">
        ...
        <Flex>
          ...
          <Edit>
            <UploadPicture
              src={user && user.pic.medium}
              ratio={1}
              path={`/users/${user._id}/photo`}
              size="500x500"
              type="photo"
              width={140}
              height={140}
        ...
        <Flex>
          ...
          <Edit className="marginMob">
            <Social className="sans-font hidden-mob">
              <i
                className="fa fa-facebook hidden-mob"
                style={{ float: 'left', margin: '20px 20px 0 0' }}
                aria-hidden="true"
              />
              <div className="hidden-mob" style={{ float: 'left', margin: '15px 20px 0 0' }}>
                facebook.com/
              </div>
              <TextField
                style={{ float: 'left', margin: '5px 0 0 0' }}
                name="channels.fb"
                value={user.channels && user.channels.fb}
                onChange={this.userChanged}
              />
            </Social>
            ...
            <Social className="sans-font hidden-mob">
              <i
                className="fa fa-twitter hidden-mob"
                style={{ float: 'left', margin: '20px 20px 0 0' }}
                aria-hidden="true"
              />
              <div className="hidden-mob" style={{ float: 'left', margin: '15px 20px 0 0' }}>
              ...
              <TextField
                style={{ float: 'left', margin: '5px 0 0 0' }}
                name="channels.twt"
                value={user.channels && user.channels.twt}
                onChange={this.userChanged}
              />
            </Social>
            <Social className="sans-font hidden-des">
            ...
            <Social className="sans-font hidden-mob">
              <i
                className="fa fa-instagram hidden-mob"
                style={{ float: 'left', margin: '20px 20px 0 0' }}
                aria-hidden="true"
              />
              <div className="hidden-mob" style={{ float: 'left', margin: '15px 20px 0 0' }}>
              ...
              <TextField
                style={{ float: 'left', margin: '5px 0 0 0' }}
                name="channels.ig"
                value={user.channels && user.channels.ig}
                onChange={this.userChanged}
              />
            </Social>
            <Social className="sans-font hidden-des">
            ...
            <Social className="sans-font hidden-mob">
              <i
                className="fa fa-youtube-play hidden-mob"
                style={{ float: 'left', margin: '20px 20px 0 0' }}
                aria-hidden="true"
              />
              <div className="hidden-mob" style={{ float: 'left', margin: '15px 20px 0 0' }}>
              ...
              <TextField
                style={{ float: 'left', margin: '5px 0 0 0' }}
                name="channels.yt"
                value={user.channels && user.channels.yt}
                onChange={this.userChanged}
              />
            </Social>
            <Social className="sans-font hidden-des">
        ...
        <div className="row hidden-des">
          <TextStatus
            style={{ color: error ? '#D8000C' : theme.accentColor, margin: '30px 0 0 15px' }}
