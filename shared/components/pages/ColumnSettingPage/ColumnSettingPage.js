...
class ColumnSettingPage extends React.Component {
  ...
  getEditors = () => {
    ...
    api.getEditors(cid).then((editors) => {
      editors = editors.map(editor => ({ text: editor.username, value: editor.id }));
  ...
  getWriters = () => {
    ...
    api.getColumnWriters(cid).then((writers) => {
      writers = writers.map(writer => ({ text: writer.username, value: writer.id }));
      ...
      <Div>
        ...
        <Container onSubmit={this.updateColumn} ref="columnForm">
          ...
          <Flex>
            ...
            <Edit>
              <TextField id="name" name="name" value={col.name} onChange={this.columnChanged} />
            </Edit>
          </Flex>
          <Flex>
            <Title>
          ...
          <Flex>
            ...
            <Edit>
              <UploadPicture
                ...
                path={`/publishers/${config.PID}/columns/${this.state.selectColumn}/cover`}
                ratio={1920 / 340}
                size="1920x340"
                height={90}
                width={480}
          ...
          <Flex>
            ...
            <Edit>
              <UploadPicture
                src={col.icon}
                path={`/publishers/${config.PID}/columns/${this.state.selectColumn}/icon`}
                ratio={120 / 120}
                size="120x120"
                height={120}
                width={120}
