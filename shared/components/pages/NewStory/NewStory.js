          ...
          <div className="col-6">
            ...
            <Layout
              style={{
                ...
                boxShadow: layout == 'NEWS' ? `0 0 10px ${theme.primaryColor}` : '',
              }}
          ...
          <div className="col-6">
            ...
            <Layout
              style={{
                ...
                boxShadow: layout == 'ARTICLE' ? `0 0 10px ${theme.primaryColor}` : '',
              }}
            ...
            >
              <BasicSetting>
                ...
                <div className="" style={{ display: 'block', clear: 'both' }}>
                  <Label
                    ...
                    style={{ float: 'left', marginTop: '22px', minWidth: '60px' }}
                  >
                      Column:{' '}
                  </Label>
                  <SelectField
                ...
                <div className="" style={{ display: 'block', overflow: 'hidden', clear: 'both' }}>
                  <Label className="nunito-font" style={{ float: 'left', marginTop: '26px' }}>
                      Add up to 5 tags:{' '}
                  </Label>
              ...
              <div className='row' style={{overflow:'hidden',marginTop:'20px'}}>
                ...
                <div className="" style={{ overflow: 'hidden', display: 'block' }}>
                  <TextStatus
                    className="sans-font"
                    style={{ color: '#DC143C', float: 'right', marginTop: '30px' }}
                  >
                    {publishStatus}
                  </TextStatus>
                </div>
                <div
                  className="row"
                  style={{ display: 'block', overflow: 'hidden', marginTop: '0px' }}
                >
                  <Delete style={{ float: 'left', margin: '10px' }} onClick={this.showAlert}>
                      Delete
                    </Delete>
                  <PrimaryButton
                    label={
                        story.status === 1
                          ? moment(story.published).format('ddd, [at] h:mm a')
                          : 'Publish'
                      }
                    style={{ float: 'right' }}
              ...
              <AdvanceSetting>
                ...
                <div className="row" style={{ display: 'block', overflow: 'hidden' }}>
                  <Label
                    className="nunito-font or"
                    style={{ float: 'left', margin: '19px 15px auto', minWidth: '80px' }}
                  >
                      URL:{' '}
                  </Label>
                  <TextField
          ...
          >
            <div className="col-6">
              <UploadPicture
                ...
                type="cover"
                style={{ width: '194px', height: '137px', margin: '0 auto 0 auto' }}
              />
            </div>
            <div className="col-6">
              <UploadPicture
                ...
                type="coverMobile"
                style={{ width: '96px', height: '137px', margin: '0 auto 0 auto' }}
              />
            </div>
          </div>
        </div>}
