		...
		this.editor = new MediumEditor('#paper', {
			toolbar: {
				buttons: [
					...
					{
						name: 'unorderedlist',
						contentDefault: '<span class="fa fa-list-ul" ></span>'
					},
					{
						name: 'justifyLeft',
		...
		$('#paper').mediumInsert({
			...
			addons: {
				images: {
					...
					styles: {
						full: {
							label: this.state.layout == 'article'
		...
		this.editor2 = new MediumEditor('#highlight', {
			toolbar: {
				buttons: [
					...
					{
						name: 'orderedlist',
						contentDefault: '<span class="fa fa-list-ol" ></span>'
					}
				]
			},
			targetBlank: true,
							...
							<BasicSetting>
								...
								<div
									...
									<Label
										...
										style={{ float: 'left', marginTop: '22px' }}>
										Column :{' '}
									</Label>
									<DropDownMenu
										value={column}
